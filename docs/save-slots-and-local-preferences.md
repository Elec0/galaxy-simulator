...
| Pacing preference | The store includes the default-enabled **Pause when response-required dialogue opens** preference defined by [Time and pacing](time-and-pacing.md). |
