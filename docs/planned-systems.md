...
| Dialogue and conversations | Define availability, conditions, choices, memory, consequences, continuity, and response-required pacing behavior. | [Dialogue state and presentation](dialogue.md), `TASK-016`; implementation in `TASK-065`, coordinated with `TASK-038` and `TASK-045`. |
